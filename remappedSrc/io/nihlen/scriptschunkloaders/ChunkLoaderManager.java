...
public class ChunkLoaderManager {
    ...
    public void registerChunkLoader(Entity entity) {
        ...
        ScriptsChunkLoadersMod.LOGGER.info("Adding {} to {}", entity, entity.method_48926().getRegistryKey().getValue());

        var worldRegistryKey = entity.method_48926().getRegistryKey();
    ...
    public void removeChunkLoader(Entity entity) {
        ScriptsChunkLoadersMod.LOGGER.info("Removing {} from {}", entity, entity.method_48926().getRegistryKey().getValue());
